...
sem=factor(sem, levels = c(1:453), labels = c(sem))
...
#pero no aparece la estimación de  ??
#Para obtener una tabla de resumen con detalles del modelo ajustado,
#se usa la función genérica summary

summary(mod1)

#Para incluir la recta de regresión que representa 
...
library(scatterplot3d)
attach(RT)
rt <-scatterplot3d(x=temp, y=o2, z=sgr, pch=16, cex.lab=1,
...
#Para incluir el plano de regresión que representa el modelo ajustado anterior 
